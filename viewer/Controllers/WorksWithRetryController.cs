...
namespace viewer.Controllers
{
    ...
    public class WorksWithRetryController : Controller
    {
        static List<string> ReceivedEventIds = new List<string>();
        ...
        public WorksWithRetryController(IHubContext<GridEventsHub> gridEventsHubContext)
        {
        ...
        private async Task<IActionResult> HandleCloudEvent(string jsonContent)
        {
            ...
            if(!ReceivedEventIds.Contains(details.Id))
            {
                ReceivedEventIds.Add(details.Id);
            ...
            else
            {
                ...
                ReceivedEventIds.Remove(details.Id);
